# PROTOCOL-001 — Frozen Scientific Protocol
...
The human-approved values in this document and `configs/protocols/protocol-v1.yaml` are the source of truth. A proposed change must include:
