...
The active 48-test suite covers environment, scientific-protocol freeze, canonical event/template schemas, checksum, dataset config/acquisition/validation/manifest behavior, and the dataset-integrity integration flow. Most parser/model/retrieval/fusion/downstream test files remain explicit placeholders and do not count as coverage. Future V3 requirements are listed in `Plan/04_TEST_PLAN.md`.
