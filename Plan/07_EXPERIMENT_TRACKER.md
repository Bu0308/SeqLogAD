# 07 — Experiment Tracker v1.1 (Historical)

> v2 experiment conditions are defined by `configs/experiments/cross_architecture_fusion.yaml` and the v2 plan. These rows remain historical and must not be read as v2 results.
