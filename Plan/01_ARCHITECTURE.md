# 01 — Architecture v1.1 (Historical Foundation)

> This file preserves the former v1.1 architecture. The forward architecture
> is [`master-implementation-plan-v2-domain-adaptive-fusion.md`](master-implementation-plan-v2-domain-adaptive-fusion.md) and [`../docs/research-protocol-v2-domain-adaptive-fusion.md`](../docs/research-protocol-v2-domain-adaptive-fusion.md).
