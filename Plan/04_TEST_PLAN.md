# 04 — Test Plan v1.1 (Historical Foundation)

> v2 test requirements are defined by `DOMAIN-ADAPTIVE-FUSION-001` and the v2 plan. The tests below remain regression coverage for the preserved v1.1 foundation.
