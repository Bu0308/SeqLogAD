# 02 — Research Plan v1.1 (Historical)

> The forward research questions are in [`../docs/research-questions.md`](../docs/research-questions.md). This file preserves the former sequence-value protocol and its evidence trail.
