...
> **SUPERSEDED FOR FUTURE WORK BY [`master-implementation-plan-v3.md`](master-implementation-plan-v3.md).** This file is preserved unchanged below as historical planning context. Active research priorities, RQ1–RQ5, expert architecture, ownership, and roadmap are defined by V3.
